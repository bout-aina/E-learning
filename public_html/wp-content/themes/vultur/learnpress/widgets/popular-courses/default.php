                ...
                <ul class="course-bottom-list">
                    <li>
                        <?php if ( ! empty( $instance['show_teacher'] ) ) { ?>
                            <span class="course-avatar"><?php echo printf($course->get_instructor()->get_profile_picture()); ?></span>
                            <span class="course-author"><?php echo esc_attr(get_the_author_meta('display_name')); ?></span>
                        <?php } ?>
                    </li>
                            ...
                            <span class=" ">
                                <?php if ( $price_html = $course->get_price_html() ) { ?>
                                    <?php if ( $course->get_origin_price() != $course->get_price() ) { ?>
                                        ...
                                        <span class="origin-price"><?php echo esc_attr($origin_price_html); ?></span>
                                    <?php } ?>
